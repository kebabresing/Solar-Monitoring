...
-- Atau jika tabel sudah ada sebelumnya, tambahkan kolom baru:
-- alter table public.protek608_telemetry add column if not exists current numeric default 0;
-- alter table public.protek608_telemetry add column if not exists power numeric default 0;
